...
def visualise_selector(pose, layer_selector, selection_name='rosetta_sele', color='red', base_color='gray', base_name='all'):
    selected_pymol = pyrosetta.rosetta.core.simple_metrics.metrics.SelectedResiduesPyMOLMetric()
